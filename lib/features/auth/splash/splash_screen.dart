...
class _SplashScreenState extends State<SplashScreen>
  ...
  // Make controllers nullable and initialize them properly
  ...
  void _startAnimations() {
    if (_isDisposed || !mounted || !_animationsInitialized) return;
      ...
      body: SafeArea(
        child: Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              // Logo with animations - only show if animations are initialized
              _animationsInitialized && _logoAnimationController != null
                  ? AnimatedBuilder(
                animation: _logoAnimationController!,
                builder: (context, child) {
                  return Transform.scale(
                    ...
                    child: FadeTransition(
                      opacity: _logoFadeAnimation ?? const AlwaysStoppedAnimation(0.0),
                      child: Container(
                        padding: const EdgeInsets.all(20),
                        child: RichText(
                          text: TextSpan(
                  ...
                  : // Fallback logo without animations
              Container(
                padding: const EdgeInsets.all(20),
                child: RichText(
                  text: TextSpan(
              ...
              // Simple progress bar - only show if animations are initialized
              _animationsInitialized && _progressAnimationController != null
                  ? AnimatedBuilder(
                animation: _progressAnimationController!,
                builder: (context, child) {
                  return FadeTransition(
                    opacity: _progressAnimation ?? const AlwaysStoppedAnimation(1.0),
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 40),
                      child: Container(
                        decoration: BoxDecoration(
                  ...
                  : // Fallback progress bar without animations
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 40),
                child: Container(
                  decoration: BoxDecoration(
